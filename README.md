...
![telegram-cloud-photo-size-2-5341424816722400957-x](https://github.com/aausachova/String.H/assets/143784011/b7e61285-d66d-452d-8c48-14f1f983f15f)
...
Необязательное задание на дополнительные баллы: реализована функцию sscanf из библиотеки stdio.h:
- Функция должна быть размещена в библиотеке s21_string.h;
- На реализацию функции накладываются все требования, изложенные в [первой части](#part-1-реализация-функции-библиотеки-stringh);
